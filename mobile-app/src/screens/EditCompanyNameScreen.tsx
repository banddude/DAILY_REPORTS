...
interface ProfileCompany { name?: string; }
...
function EditCompanyNameScreen(): React.ReactElement {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      const payload = { ...fullProfile, company: { ...(fullProfile.company || {}), name: currentValue } };
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
      <ScrollView style={styles.container}>
        ...
        <TextInput style={styles.textInput} value={currentValue} onChangeText={setCurrentValue} placeholder="Enter company name" editable={!isSaving} autoCapitalize="words" />
      </ScrollView>
    </SafeAreaView>
  );
}
