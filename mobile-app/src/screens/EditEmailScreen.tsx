...
interface ProfileData { email?: string; }
...
function EditEmailScreen(): React.ReactElement {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      const payload = { ...fullProfile, email: currentValue };
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
      <ScrollView style={styles.container}>
        ...
        <TextInput style={styles.textInput} value={currentValue} onChangeText={setCurrentValue} placeholder="Enter your email" editable={!isSaving} autoCapitalize="none" keyboardType="email-address" autoComplete='email' />
      </ScrollView>
    </SafeAreaView>
  );
}
