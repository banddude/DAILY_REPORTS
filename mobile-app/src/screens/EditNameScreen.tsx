...
interface ProfileData { name?: string; }
...
function EditNameScreen(): React.ReactElement {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      const payload = { ...fullProfile, name: currentValue };
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
      <ScrollView style={styles.container}>
        ...
        <TextInput style={styles.textInput} value={currentValue} onChangeText={setCurrentValue} placeholder="Enter your name" editable={!isSaving} autoCapitalize="words" autoComplete='name' />
      </ScrollView>
    </SafeAreaView>
  );
}
