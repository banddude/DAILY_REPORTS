...
import { EditWhisperModelScreenProps } from '../navigation/AppNavigator';
...
// --- Styles (Keep same as Chat Model editor) ---
...
// --- Component ---
function EditWhisperModelScreen(): React.ReactElement {
  const navigation = useNavigation<EditWhisperModelScreenProps['navigation']>();
  ...
  const fetchCurrentModel = useCallback(async () => {
    ...
    try {
      ...
      const model = data?.config?.whisperModel || '';
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      const payload = { ...fullProfile, config: { ...(fullProfile.config || {}), whisperModel: currentModel } };
  ...
  // Configure Header Buttons (remains the same logic)
  useLayoutEffect(() => {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
       <ScrollView style={styles.container}>
            ...
            <Text style={styles.label}>Whisper Model Name</Text>
            <TextInput
...
export default EditWhisperModelScreen; 