...
exports.initializeProfileRoutes = void 0;
...
let imageUploadMiddleware; // For logo and profile image
let uploadsDir;
// Initializer function
const initializeProfileRoutes = (client, bucket, protect, ensureAuth, imageUpload, uploadsDirectory) => {
    s3Client = client;
    s3Bucket = bucket;
...
exports.initializeProfileRoutes = initializeProfileRoutes;
// --- Profile Routes ---
// GET Endpoint for retrieving profile data from Supabase
router.get('/profile', (req, res, next) => protectMiddleware(req, res, next), ((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { data: profileData, error } = yield config_1.supabase
            .from('profiles')
        ...
        const { id } = profileData, profileResponseData = __rest(profileData, ["id"]);
...
router.post('/profile', (req, res, next) => protectMiddleware(req, res, next), ((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = ensureAuthenticatedHelper(req, res);
    if (!userId)
        return;
...
router.post('/upload-logo', (req, res, next) => protectMiddleware(req, res, next), (req, res, next) => imageUploadMiddleware(req, res, next), (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = ensureAuthenticatedHelper(req, res);
    if (!userId) {
        return;
    }
    ...
    if (!req.file && req.body && req.body.logo && typeof req.body.logo === 'object') {
        ...
        try {
            ...
            req.file = {
                ...
                path: path_1.default.join(uploadsDir, `${Date.now()}-${req.body.logo.name || 'logo.jpg'}`),
            };
    ...
    try {
        ...
        const region = (yield s3Client.config.region()) || process.env.AWS_REGION || 'us-west-2';
        ...
        const { error: updateError } = yield config_1.supabase
            .from('profiles')
            .update({
...
router.get('/logo/:userId', ((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
